		...
		<div class="ml-auto relative group">
			...
			{#if showMenu}
				<button
					...
					onclick={() => (showMenu = false)}></button>
			{/if}

			<button
				class="relative z-20 flex items-center justify-center p-2 text-white hover:text-teal-300 cursor-pointer"
...
<main class="font-[Roboto Variable] relative flex h-screen w-screen font-sans text-sm">
	{@render children()}
</main>
